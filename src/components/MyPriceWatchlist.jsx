...
// A component for users to track their favorite products with price change tracking.
            ...
            <tbody>
              {watchedProducts.map(product => (
                <tr key={product.$id} className="border-b border-gray-200 hover:bg-gray-50">
                  ...
                  <td className="px-5 py-4">
                    <div className="flex items-center">
                      <p className="text-gray-800 font-bold text-lg mr-2">{`₦${(product.ownerPrice || 0).toLocaleString()}`}</p>
