...
const MarketCard = ({ market }) => {
  return (
    <div className="bg-white rounded-2xl shadow-lg flex flex-col h-full border border-gray-200/80 transform hover:-translate-y-2 transition-transform duration-300 overflow-hidden">
      <ImageWithFallback
      ...
      <div className="p-6 flex flex-col flex-grow">
        <div className="flex-grow">
          <div className="flex items-center mb-3">
            <FiMapPin className="text-green-600 mr-3 flex-shrink-0" />
